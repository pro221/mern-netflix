    ...
    <Container showPassword={showPassword}>
      ...
      <div className='body flex column a-center j-center'>
        <div className='text flex column'>
          <h1>Unlimited movies,TV shows and Web Series</h1>
          <h4>Watch anywhere. Watch anytime.</h4>
          <h6>
            Excited to watch? Enter your Email to create membership
         </h6>
          
        </div>
        <div className="form">
          <input type="email" placeholder='Email ID' name='email' value={formValues.email} onChange={(e)=>setFormValues({...formValues,[e.target.name] :e.target.value})} />
          {
            showPassword && (
